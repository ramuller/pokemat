...
def reconnect(port, phone):
    ...
    while True:
        try:
            ...
            phone.ccolor_match_wait_click(914, 583, 149, 97, 121, time_out_ms=20000)
            print("Color match")
            time.sleep(1)
            ...
            # phone.ccolor_match_wait_click(241, 369, 143, 208, 218)
            time.sleep(1)
            print("TAP connect")
            ...
            # phone.ccolor_match_wait_click(807, 1189, 29, 88, 102)
