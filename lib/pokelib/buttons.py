...
class Buttons(ButtonParameter):
    def __init__(self, reg):
        ...
        self.t_pokestop_battle = TextButton(ScreenRegion(ts,
                                        ...
                                        process=True),                                       
                                        'BATTLE')
        self.t_battle_lets_go = TextButton(ScreenRegion(ts,
                                        invert=True,
                                        process=True,
                                        xs=ts.rel_x(0.0),
                                        xe=ts.rel_x(1.0),
        ...
        self.i_fake_3dot = IconButton(ScreenRegion(ts, ye=ts.rel_y(0.2)), 'fake_3dot')
        self.i_fake_map = IconButton(ScreenRegion(ts, ye=ts.rel_y(0.2)), 'fake_map')
        self.i_fake_search = IconButton(ScreenRegion(ts, ye=ts.rel_y(0.2)), 'fake_search')
        ...
        self.b_yes = TextButton(ScreenRegion(ts,
                                    ...
                                    ye=ts.rel_y(0.80)),
                                    'YES')
        self.b_battle_claim = TextButton(ScreenRegion(ts,
                                    invert=True,
                                    process=True,
                                    blur=3,
                                    xs=ts.rel_x(0.00),
                                    ...
                                    ye=ts.rel_y(1.00)),
                                    'CLAIM')
        self.b_battle_battle = TextButton(ScreenRegion(ts,
                                    invert=True,
                                    process=True,
                                    blur=3,
                                    xs=ts.rel_x(0.00),
        ...
        self.t_send_gift = TextFlat(ScreenRegion(ts,
                                    ...
                                    color='gray'),
                                    'SEND')
        self.t_info_dismiss = TextFlat(ScreenRegion(ts,
                                    xs=ts.rel_x(0.10),
                                    xe=ts.rel_x(0.90),
                                    ys=ts.rel_y(0.80),
                                    ye=ts.rel_y(1),
