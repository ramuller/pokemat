...
evolve.py -f '\a  evolve&!favorite&grimer,gible,glameow,gossifleur,groomy,golett,goldeen'
evolve.py -f '\a  evolve&!favorite&grookey,hatenna,helioptile,hoothoot,hoppip'
evolve.py -f '\a  evolve&favorite&grovyle,growlithe,grubbin,gulpin,hatenna,hekioptile,honedge,hoothoot,hoppip,houndour'
evolve.py -f '\a  evolve&!favorite&houndour,jigglybuff,jangmo,'
evolve.py -f '\a  evolve&!favorite&joltik,krabby,kricketot,larvitar,lechonk'
evolve.py -f '\a  evolve&!favorite&slakoth,mienfoo,omanyte,ledyba,lileep,lillipup,litleo,litwick'

evolve.py -f '\a  evolve&!favorite&lotad,lechnok,lotad,mankey'

# delete many
evolve.py -f '\a  evolve&!favorite&mantyke,marenaie,mareepmarill,meditite,meowth,mienfoo,miniccino,morelull,mudkip'
evolve.py -f '\a  evolve&!favorite&natu,nickit,nidoran,nincada,charjabug,numel,nymble,oddish'
evolve.py -f '\a  evolve&!favorite&oshawott,paras,ptrat,pawmi,pawniard,phanpy,pichu,pikipek,pineco,piplup'
evolve.py -f '\a  evolve&!favorite&poliwag,ponyta'
evolve.py -f '\a  evolve&!favorite&poochyne,popplio,psyduck,purrloin'
evolve.py -f '\a  evolve&!favorite&quaxly,rowlet,rookidee,riolu,ryhorn'
evolve.py -f '\a  evolve&!favorite&remoraid,rattata,ralts'
evolve.py -f '\a  evolve&!favorite&,swinhub,surskit,stunky,starly'
evolve.py -f '\a  evolve&!favorite&squirtle,sprigatito,spoink,spinarak'
evolve.py -f '\a  evolve&!favorite&speal,spearow,solosis'
evolve.py -f '\a  evolve&!favorite&sobble,snubbull,snover'
evolve.py -f '\a  evolve&!favorite&snivy,smoliv,slugma,skwovet,skrelp,skorupi,skitty,skiddo,sizzlipede'
evolve.py -f '\a  evolve&!favorite&shroomish,shinx,shieldon,sandile,sandshrew,sandygast,scatterbug,scorbunny,scraggy,seedot,scorbunny'
evolve.py -f '\a  evolve&!favorite&sentret,sewaddle,shellder,sellos,taillow,teddiursa,tepig,todile,tinkatink,totodile'
evolve.py -f '\a  evolve&!favorite&trubbish,treecko,trabinch,tynamo,vanillite,varoom'

evolve.py -f '\a  evolve&!favorite&venipede,voltrop,vullaby,vulpix,wooloo,wooper'

evolve.py -f '\a  evolve&!favorite&wurmple'
evolve.py -f '\a  evolve&!favorite&weedle,wynaunt'


# big group
evolve.py -f '\a  evolve&!favorite&whismur,pidove'
evolve.py -f '\a  evolve&!favorite&pidgey'

evolve.py -f '\a  evolve&!favorite&flab'
evolve.py -f '\a  evolve&!favorite&gothita'
